...
/**
 * This data.parser reads RobinHood traces as generated by the creators of the RobinHood policy.
 * traces: https://github.com/dasebe/robinhoodcache/blob/master/tracegen/trace.json
 * RobinHood simulation.policy paper: https://www.usenix.org/system/files/osdi18-berger.pdf
 */
            ...
            while (fieldsIterator.hasNext()) {
                ...
                for (int i = 0; i < sizes.length; i++) {
                    if (cachables[i] != 1 && cachables[i] != 0) {
                        System.err.print(
                                "ERROR: The field C can be either 0 or 1, but instead it was "
                                + cachables[i] + "\n");
                    }
