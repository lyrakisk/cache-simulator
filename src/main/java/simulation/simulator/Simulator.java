 ...
 * It uses a simulation.policy and a stream of records and keeps track of
 * various metrics (cache hits etc.) about the performance of
 * the chosen simulation.policy.
 */
public class Simulator {
    ...
    public Result[] simulate() {
        ...
        // get the number of operations from each simulation.policy
    ...
    /**
     * This function processes a data.record and updates the results of the simulation.
    ...
    public void processRecord(Record record, Result[] results) {
        for (int i = 0; i < results.length; i++) {
            ...
            // Send the data.record to the simulation.policy to process it.
